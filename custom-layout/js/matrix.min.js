...
// Matrix init
jQuery.noConflict(),function(a){a(document).ready((function(){"center"==a(".cc-bs").css("text-align")&&a("body").addClass("matrix");var e=a(window).height();a(".lazy").each((function(){offsetTop=a(this).offset().top,offsetTop<e&&a(this).addClass("loaded")})),a(window).on("scroll",(function(){scrollTop=a(window).scrollTop(),a(".lazy").each((function(){offsetTop=a(this).offset().top-scrollTop,offsetTop<e&&a(this).addClass("loaded")}))})),a('<a href="#0" class="cd-btn hs-button"></a><div class="cd-panel from-left"> <header class="cd-panel-header link-white"> <span><a style="text-decoration: none!important;" href="https://www.matrix-themes.com/support/admin/" target="iframe-holder">Matrix Themes</a></span> <a href="#0" class="cd-panel-close">Close</a> </header> <div class="cd-panel-container rel"> <div class="cd-panel-content left-align"> <div class="invisibleh"> <a class="mt" href="https://www.matrix-themes.com/support/documentation/" target="iframe-holder" title="">Documentation</a> <a class="mt" href="https://www.matrix-themes.com/support/quick-setup/" target="iframe-holder" title="">Quick setup</a> <a class="mt" href="https://www.matrix-themes.com/support/shortcodes/" target="iframe-holder" title="">Shortcodes</a> <a class="mt" href="https://www.matrix-themes.com/support/block-elements/" target="iframe-holder" title="">Block elements</a> <a class="mt" href="https://www.matrix-themes.com/support/fluid-sections/" target="iframe-holder" title="">Fluid sections</a><a class="mt" href="https://www.matrix-themes.com/support/enterprise-package/" target="iframe-holder" title="">Add-ons</a><a class="mt" href="https://www.matrix-themes.com/support/updates" target="iframe-holder" title="">Updates</a> <a class="mt" href="https://www.matrix-themes.com/support/helper-classes/" target="iframe-holder" title="">Helper classes</a><a class="mt" href="https://www.matrix-themes.com/support/help/" target="iframe-holder" title="">Support</a><a class="mt" href="https://www.matrix-themes.com/support/marketplace/" target="iframe-holder" title="">Marketplace</a><a class="popup-vimeo mt weight-600" href="https://cms.e.jimdo.com/app/siteadmin/layout/api/" title="">Custom layout</a></div></div><div class="left-align" style="padding: 50px 0px 0 0px;height:100%;width: auto;overflow:hidden;"> <div class="cc-box"> <iframe name="iframe-holder" id="iframe-holder" class="" style="height:100%;box-sizing: border-box;display: block;"></iframe> </div></div></div></div>').insertAfter("#hs-container"),a(".cd-btn").on("click",(function(e){e.preventDefault(),a("#cms",window.parent.document).parent().parent().parent().parent().parent().css("top","0").css("height","100%")})),a(".cd-panel").on("click",(function(e){(a(e.target).is(".cd-panel")||a(e.target).is(".cd-panel-close"))&&(a("#cms",window.parent.document).parent().parent().parent().parent().parent().css("top","48px").css("height","calc(100vh - 48px)"),e.preventDefault())})),a('.j-module:contains("is-white-label")').length&&a(".cd-btn").css("opacity","0"),a(".cc-m-help-button").click((function(){a(".cd-btn").css("opacity","1")})),a(".hs-menu ul").superfish({delay:500,animation:{opacity:"show",height:"show"},speed:"fast",autoArrows:!1}),a(".hs-mega .j-nav-variant-nested > ul > li:has( > ul)").addClass("menu-dropdown-icon"),a(".hs-mega  .j-nav-variant-nested > ul > li > ul:not(:has(ul))").addClass("normal-sub"),a(".hs-mega .j-nav-variant-nested > ul > li").hover((function(e){a(window).width()>943&&(a(this).children(".hs-mega ul").stop(!0,!1).fadeToggle(150),e.preventDefault())})),/Android/i.test(navigator.userAgent)&&a(".menu-dropdown-icon").one("click",!1),a(".menu").slicknav({duplicate:!1,closedSymbol:"+",openedSymbol:"-",label:"",allowParentLinks:!0,prependTo:".m-wrapper"}),a("#toggle").click((function(){a(this).toggleClass("active"),a("#overlay").toggleClass("open")})),a(".jarallax").jarallax({speed:.2}),a(window).enllax(),(new universalParallax).init(),a(".bg-caption,.single-caption").fadeIn().css("display","block"),a(".is-fadein").fadeIn(1e3).css("display","flex"),a(".is-fadein-block").fadeIn(1e3).css("display","block"),a(".cd-btn").on("click",(function(e){e.preventDefault(),a(".cd-panel").addClass("is-visible"),a(".has-push-layout").addClass("is-pushed")})),a(".cd-panel").on("click",(function(e){(a(e.target).is(".cd-panel")||a(e.target).is(".cd-panel-close"))&&(a(".cd-panel").removeClass("is-visible"),a(".has-push-layout").removeClass("is-pushed"),e.preventDefault())})),a(".mt").on("click",(function(e){a("a.mt").removeClass("active"),a(this).addClass("active")})),a(".popup-youtube, .popup-vimeo, .popup-gmaps").magnificPopup({disableOn:200,type:"iframe",mainClass:"mfp-fade",removalDelay:160,preloader:!1,fixedContentPos:!1}),a(".popup-with-zoom-anim").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-zoom-in"}),a(".fixed,.fixed-mobile").sticky({topSpacing:0});var t=a(".main-equal").height();a(".equal").css("min-height",t),a(".onepager").onePageNav(),a(".onepager nav ul li a").click((function(){a(".overlay").removeClass("open"),a(".button_container").toggleClass("active")})),a(".onepager nav ul li").click((function(){a(".onepager nav ul li").removeClass("current"),a(this).addClass("current")})),a("img").each((function(){const e=a(this).closest(".j-module"),t=a(this).closest(".j-hgrid");e.length&&!t.length?e.addClass(a(this).attr("alt")):t.length&&a(this).addClass(a(this).attr("alt"))})),a(".j-hgrid").addClass("loaded"),a(".cc-imagewrapper").addClass("matrix-img"),a(".j-hgrid").wrap("<div class='matrix-grid' />"),a(".cc-m-hgrid-column > div").wrap("<div class='matrix-column' />"),a("ins").each((function(){a(this).closest(".matrix-column").addClass(a(this).text()),a(this).closest(".j-module").addClass("has-padding")})),a("var").each((function(){a(this).closest(".matrix-grid").addClass(a(this).text()),a(this).closest(".j-module").addClass("has-padding")})),a(".draggable-hero").appendTo(a(".is-hero-draggable")),a(".draggable-logo").appendTo(a(".hs-logo")),a(".draggable-header").appendTo(a(".hs-header .is--center,.overlay .magic-field")),a(".draggable-top-header").insertBefore(a(".hs-header")),a(".draggable-top-header.has-large-inner .matrix-column").addClass("add-5"),a(".draggable-top-header.has-inner > .j-hgrid").addClass("inner"),a(".draggable-logo").appendTo(a(".hs-logo")),a(".draggable-top-header").insertBefore(a(".hs-header")),a(".draggable-btm-header").insertAfter(a(".hs-header")),a(".magic-field").has(".onepager").length&&a(".magic-field").addClass("center-align"),a(".draggable-hero").hasClass("has-primary-overlay")&&a(".matrix-hero .hs-overlay").addClass("bg-primary"),a(".cc-m-htmlcode").hover((function(){a("var,ins",this).show().css("display","block")}),(function(){a("var,ins",this).hide()})),a(".hs-magic,.draggable-right-header").appendTo(a(".magic-field")),a(".cc-jimdo").removeClass("cc-m-blogselection"),a(".has-sidebar-menu").appendTo(a(".sidebar-nav")),a("div").hasClass("has-transparent-header")&&(a("#cc-inner .hs-header").addClass("").attr("style","position:absolute;background: transparent!important;"),a("body").addClass("has-transparent-header")),a("div").hasClass("has-sticky-white")&&a("body").addClass("has-sticky-white"),a("div").hasClass("no-hero")&&a("body").addClass("no-hero"),a(".draggable-hero").hasClass("has-btm-arrow")&&a(".matrix-hero").addClass("is-matrix has-btm-arrow"),a(".draggable-hero").hasClass("has-white-overlay")&&a(".matrix-hero .hs-overlay").css({"background-color":"white"}).css({opacity:"0.4"}),a("div").hasClass("has-no-gutter")&&(a(".hs-content .gutter").css({padding:"0"}),a("body").addClass("hide-subnav")),a(".is-switcher").appendTo(a(".style-switcher")),a(".cc-content-parent").css("opacity","1"),a(".j-calltoaction-wrapper").fadeIn(1e3).css("display","block"),a(".j-htmlCode .hs-button,#cc-inner #hs-container .j-formnew input").fadeIn(1e3).css("display","inline-block"),a(".draggable-hero").hasClass("main-page")&&a("body").addClass("main-page"),a("head").append('<meta name="viewport" content="width=device-width, initial-scale=1"/>'),a("div.toggle > div.content").hide(),a("div.toggle > a.switch.opened").next().show(),a("div.toggle > a.switch").click((function(){return a(this).toggleClass("opened").next().slideToggle("fast"),!1})),a(".accordeon_content").hide(),a(".accordeon_title").click((function(){a(this).parent().toggleClass("active").siblings().removeClass("active"),a(".accordeon_content").slideUp(),a(this).next().is(":visible")||a(this).next().slideDown()})),a("ul.tabs-nav > li:first-child").addClass("active"),a("div.tab-content").hide(),a("div.tab-content:first-child").show(),a("ul.tabs-nav a").click((function(){var e=a(this).parent().parent("ul.tabs-nav");if(!a(this).parent().hasClass("active")){a("> li",e).removeClass("active"),a(this).parent().addClass("active");var t=a(this).attr("href"),s=a("div.tabs-container").has(t);a("> .tab-content",s).hide(),a(t,s).fadeIn()}return!1})),a('a[href^="*"]').on("click",(function(e){e.preventDefault();var t=this.hash,s=a(t);a("html, body").stop().animate({scrollTop:s.offset().top},900,"swing",(function(){window.location.hash=t}))})),a(".is-fullwidth.is-col-1 .cc-m-gallery-stack-column").css("width","100%"),a(".is-fullwidth.is-col-2 .cc-m-gallery-stack-column").css("width","50%"),a(".is-fullwidth.is-col-3 .cc-m-gallery-stack-column").css("width","33.33333333%"),a(".is-fullwidth.is-col-4 .cc-m-gallery-stack-column").css("width","25%"),a(".is-fullwidth .cc-m-gallery-stack-column .cc-m-gallery-stack-item img").attr("style","height:  auto"),a(".is-matrix-parallax img").each((function(e,t){var s=a(t),i=a("<div class='hs-fullwidth is-parallax ' />").css({background:"url("+s.attr("src")+") no-repeat center"});s.replaceWith(i)})),wow=new WOW({boxClass:"wow",animateClass:"animate__animated",mobile:!0,offset:100}),wow.init()}))}(jQuery);
