...
// Matrix init
jQuery.noConflict(),function(s){s(document).ready(function(){"center"==s(".cc-bs").css("text-align")&&s("body").addClass("matrix");var e=s(window).height();s(".lazy").each(function(){offsetTop=s(this).offset().top,offsetTop<e&&s(this).addClass("loaded")}),s(window).on("scroll",function(){scrollTop=s(window).scrollTop(),s(".lazy").each(function(){offsetTop=s(this).offset().top-scrollTop,offsetTop<e&&s(this).addClass("loaded")})}),s('<a href="#0" class="cd-btn hs-button"></a><div class="cd-panel from-left"> <header class="cd-panel-header link-white"> <span><a style="text-decoration: none!important;" href="https://www.matrix-themes.com/support/admin/" target="iframe-holder">Matrix Themes</a></span> <a href="#0" class="cd-panel-close">Close</a> </header> <div class="cd-panel-container rel"> <div class="cd-panel-content left-align"> <div class="invisibleh"> <a class="mt" href="https://www.matrix-themes.com/support/documentation/" target="iframe-holder" title="">Documentation</a> <a class="mt" href="https://www.matrix-themes.com/support/quick-setup/" target="iframe-holder" title="">Quick setup</a> <a class="mt" href="https://www.matrix-themes.com/support/shortcodes/" target="iframe-holder" title="">Shortcodes</a> <a class="mt" href="https://www.matrix-themes.com/support/block-elements/" target="iframe-holder" title="">Block elements</a> <a class="mt" href="https://www.matrix-themes.com/support/fluid-sections/" target="iframe-holder" title="">Fluid sections</a><a class="mt" href="https://www.matrix-themes.com/support/enterprise-package/" target="iframe-holder" title="">Add-ons</a><a class="mt" href="https://www.matrix-themes.com/support/updates" target="iframe-holder" title="">Updates</a> <a class="mt" href="https://www.matrix-themes.com/support/helper-classes/" target="iframe-holder" title="">Helper classes</a><a class="mt" href="https://www.matrix-themes.com/support/help/" target="iframe-holder" title="">Support</a><a class="mt" href="https://www.matrix-themes.com/support/marketplace/" target="iframe-holder" title="">Marketplace</a><a class="popup-vimeo mt weight-600" href="https://cms.e.jimdo.com/app/siteadmin/layout/api/" title="">Custom layout</a></div></div><div class="left-align" style="padding: 50px 0px 0 0px;height:100%;width: auto;overflow:hidden;"> <div class="cc-box"> <iframe name="iframe-holder" id="iframe-holder" class="" style="height:100%;box-sizing: border-box;display: block;"></iframe> </div></div></div></div>').insertAfter("#hs-container"),s(".cd-btn").on("click",function(e){e.preventDefault(),s("#cms",window.parent.document).parent().parent().parent().parent().parent().css("top","0").css("height","100%")}),s(".cd-panel").on("click",function(e){(s(e.target).is(".cd-panel")||s(e.target).is(".cd-panel-close"))&&(s("#cms",window.parent.document).parent().parent().parent().parent().parent().css("top","48px").css("height","calc(100vh - 48px)"),e.preventDefault())}),s('.j-module:contains("is-white-label")').length&&s(".cd-btn").css("opacity","0"),s(".cc-m-help-button").click(function(){s(".cd-btn").css("opacity","1")}),s(".hs-menu ul").superfish({delay:500,animation:{opacity:"show",height:"show"},speed:"fast",autoArrows:!1}),s(".hs-mega .j-nav-variant-nested > ul > li:has( > ul)").addClass("menu-dropdown-icon"),s(".hs-mega  .j-nav-variant-nested > ul > li > ul:not(:has(ul))").addClass("normal-sub"),s(".hs-mega .j-nav-variant-nested > ul > li").hover(function(e){943<s(window).width()&&(s(this).children(".hs-mega ul").stop(!0,!1).fadeToggle(150),e.preventDefault())}),/Android/i.test(navigator.userAgent)&&s(".menu-dropdown-icon").one("click",!1),s(".menu").slicknav({duplicate:!1,closedSymbol:"+",openedSymbol:"-",label:"",allowParentLinks:!0,prependTo:".m-wrapper"}),s("#toggle").click(function(){s(this).toggleClass("active"),s("#overlay").toggleClass("open")}),s(".jarallax").jarallax({speed:.2}),s(window).enllax(),(new universalParallax).init(),s(".bg-caption,.single-caption").fadeIn().css("display","block"),s(".is-fadein").fadeIn(1e3).css("display","flex"),s(".is-fadein-block").fadeIn(1e3).css("display","block"),s(".cd-btn").on("click",function(e){e.preventDefault(),s(".cd-panel").addClass("is-visible"),s(".has-push-layout").addClass("is-pushed")}),s(".cd-panel").on("click",function(e){(s(e.target).is(".cd-panel")||s(e.target).is(".cd-panel-close"))&&(s(".cd-panel").removeClass("is-visible"),s(".has-push-layout").removeClass("is-pushed"),e.preventDefault())}),s(".mt").on("click",function(e){s("a.mt").removeClass("active"),s(this).addClass("active")}),s(".popup-youtube, .popup-vimeo, .popup-gmaps").magnificPopup({disableOn:200,type:"iframe",mainClass:"mfp-fade",removalDelay:160,preloader:!1,fixedContentPos:!1}),s(".popup-with-zoom-anim").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-zoom-in"}),s(".fixed,.fixed-mobile").sticky({topSpacing:0});var a=s(".main-equal").height();s(".equal").css("min-height",a),s(".onepager").onePageNav(),s(".onepager nav ul li a").click(function(){s(".overlay").removeClass("open"),s(".button_container").toggleClass("active")}),s(".onepager nav ul li").click(function(){s(".onepager nav ul li").removeClass("current"),s(this).addClass("current")}),s("img").each(function(){s(this).closest(".j-module").addClass(s(this).attr("alt"))}),s(".j-hgrid").addClass("loaded"),s(".cc-imagewrapper").addClass("matrix-img"),s(".j-hgrid").wrap("<div class='matrix-grid' />"),s(".cc-m-hgrid-column > div").wrap("<div class='matrix-column' />"),s("ins").each(function(){s(this).closest(".matrix-column").addClass(s(this).text()),s(this).closest(".j-module").addClass("has-padding")}),s("var").each(function(){s(this).closest(".matrix-grid").addClass(s(this).text()),s(this).closest(".j-module").addClass("has-padding")}),s(".draggable-hero").appendTo(s(".is-hero-draggable")),s(".draggable-logo").appendTo(s(".hs-logo")),s(".draggable-header").appendTo(s(".hs-header .is--center,.overlay .magic-field")),s(".draggable-top-header").insertBefore(s(".hs-header")),s(".draggable-top-header.has-large-inner .matrix-column").addClass("add-5"),s(".draggable-top-header.has-inner > .j-hgrid").addClass("inner"),s(".draggable-logo").appendTo(s(".hs-logo")),s(".draggable-top-header").insertBefore(s(".hs-header")),s(".draggable-btm-header").insertAfter(s(".hs-header")),s(".magic-field").has(".onepager").length&&s(".magic-field").addClass("center-align"),s(".draggable-hero").hasClass("has-primary-overlay")&&s(".matrix-hero .hs-overlay").addClass("bg-primary"),s(".cc-m-htmlcode").hover(function(){s("var,ins",this).show().css("display","block")},function(){s("var,ins",this).hide()}),s(".hs-magic,.draggable-right-header").appendTo(s(".magic-field")),s(".cc-jimdo").removeClass("cc-m-blogselection"),s(".has-sidebar-menu").appendTo(s(".sidebar-nav")),s("div").hasClass("has-transparent-header")&&(s("#cc-inner .hs-header").addClass("").attr("style","position:absolute;background: transparent!important;"),s("body").addClass("has-transparent-header")),s("div").hasClass("has-sticky-white")&&s("body").addClass("has-sticky-white"),s("div").hasClass("no-hero")&&s("body").addClass("no-hero"),s(".draggable-hero").hasClass("has-btm-arrow")&&s(".matrix-hero").addClass("is-matrix has-btm-arrow"),s(".draggable-hero").hasClass("has-white-overlay")&&s(".matrix-hero .hs-overlay").css({"background-color":"white"}).css({opacity:"0.4"}),s("div").hasClass("has-no-gutter")&&(s(".hs-content .gutter").css({padding:"0"}),s("body").addClass("hide-subnav")),s(".is-switcher").appendTo(s(".style-switcher")),s(".cc-content-parent").css("opacity","1"),s(".j-calltoaction-wrapper").fadeIn(1e3).css("display","block"),s(".j-htmlCode .hs-button,#cc-inner #hs-container .j-formnew input").fadeIn(1e3).css("display","inline-block"),s(".draggable-hero").hasClass("main-page")&&s("body").addClass("main-page"),s("head").append('<meta name="viewport" content="width=device-width, initial-scale=1"/>'),s("div.toggle > div.content").hide(),s("div.toggle > a.switch.opened").next().show(),s("div.toggle > a.switch").click(function(){return s(this).toggleClass("opened").next().slideToggle("fast"),!1}),s(".accordeon_content").hide(),s(".accordeon_title").click(function(){s(this).parent().toggleClass("active").siblings().removeClass("active"),s(".accordeon_content").slideUp(),s(this).next().is(":visible")||s(this).next().slideDown()}),s("ul.tabs-nav > li:first-child").addClass("active"),s("div.tab-content").hide(),s("div.tab-content:first-child").show(),s("ul.tabs-nav a").click(function(){var e,a=s(this).parent().parent("ul.tabs-nav");return s(this).parent().hasClass("active")||(s("> li",a).removeClass("active"),s(this).parent().addClass("active"),e=s(this).attr("href"),a=s("div.tabs-container").has(e),s("> .tab-content",a).hide(),s(e,a).fadeIn()),!1}),s('a[href^="*"]').on("click",function(e){e.preventDefault();var a=this.hash,e=s(a);s("html, body").stop().animate({scrollTop:e.offset().top},900,"swing",function(){window.location.hash=a})}),s(".is-fullwidth.is-col-1 .cc-m-gallery-stack-column").css("width","100%"),s(".is-fullwidth.is-col-2 .cc-m-gallery-stack-column").css("width","50%"),s(".is-fullwidth.is-col-3 .cc-m-gallery-stack-column").css("width","33.33333333%"),s(".is-fullwidth.is-col-4 .cc-m-gallery-stack-column").css("width","25%"),s(".is-fullwidth .cc-m-gallery-stack-column .cc-m-gallery-stack-item img").attr("style","height:  auto"),s(".is-matrix-parallax img").each(function(e,a){var t=s(a),a=s("<div class='hs-fullwidth is-parallax ' />").css({background:"url("+t.attr("src")+") no-repeat center"});t.replaceWith(a)}),wow=new WOW({boxClass:"wow",animateClass:"animate__animated",mobile:!0,offset:100}),wow.init()})}(jQuery);
